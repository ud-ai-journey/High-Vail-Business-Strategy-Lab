...
export const portfolioProjects: Project[] = [
  {
    id: 'chils',
    title: 'CHILS & CO',
    subtitle: 'Premium apparel ecommerce experience — launching tomorrow',
    link: 'https://chilsandco.com',
    bgColor: 'from-neutral-900 via-neutral-950 to-amber-950/20',
    accentColor: '#c6a66b',
    stats: ['Launching Tomorrow', 'Integrated Custom Shop', 'Marketing Coming'],
    description: 'A comprehensive branding and ecommerce ecosystem for CHILS & CO launching tomorrow, with targeted brand marketing campaigns coming next.',
    ...
    impact: 'Launches tomorrow with an optimized digital engine; strategic brand marketing pipelines are set to deploy shortly to drive high-conversion organic social retention.',
  ...
  },
  {
    ...
    subtitle: 'Digitized ultra-premium agricultural brand — sold out',
    link: 'https://mogalthur-mangoes.vercel.app',
    bgColor: 'from-stone-900 via-stone-950 to-yellow-950/20',
    accentColor: '#d4af37',
    stats: ['400K+ Views', '100% Harvest Sold Out', 'Profits Tripled'],
    ...
    impact: 'Drove over 400,000 views within a span of 25 days, completely selling out the entire farm harvest and tripling their net margins.',
  ...
  },
  {
    ...
    subtitle: 'Traditional heritage farm digital transformation — launching next summer',
    link: 'https://swami-reddy-mango-farm.vercel.app',
    bgColor: 'from-neutral-950 via-stone-900 to-amber-900/10',
    accentColor: '#c6a66b',
    stats: ['Starting Next Summer', 'Content Coming 2027', 'Zero Middlemen'],
    description: 'Transforming a multi-decade heritage estate into a high-demand premium digital brand scheduled to deploy next summer.',
    ...
    impact: 'Expected to officially start next summer, with a comprehensive premium content series scheduled to launch next year to secure direct-to-consumer subscriptions.',
  ...
  },
  {
    id: 'cocoamrut',
    title: 'COCOAMRUT',
    subtitle: 'Natural cold-pressed coconut oil brand — active',
    link: 'https://cocoamrut.vercel.app',
    bgColor: 'from-neutral-900 via-neutral-950 to-emerald-950/10',
    accentColor: '#d4af37',
    stats: ['Baby Brand Thriving', 'Content in Pipeline', 'Premium Positioned'],
    description: 'A thriving, pure cold-pressed coconut oil baby brand created by a female founder, performing extraordinarily well in the market.',
    ...
    impact: 'Doing incredibly well under female leadership with custom storytelling visual content currently in the pipeline to expand digital outreach.',
  ...
  },
  {
    ...
    subtitle: 'Elite living experience and localized market leader',
    link: 'https://kamakhya-coliving.vercel.app',
    bgColor: 'from-stone-950 via-neutral-900 to-rose-950/10',
    accentColor: '#c6a66b',
    stats: ['100% Occupancy', 'Surrounding Leader', 'Premium Reputation'],
    ...
    impact: 'Achieved 100% occupant capacity and established a dominant market reputation as the absolute premium tier coliving experience in its surroundings.',
